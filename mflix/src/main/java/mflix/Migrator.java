...
public class Migrator {
    ...
    private static UpdateOneModel<Document> transformRating(Document doc) {
        try {
            ...
            Bson bson = Filters.in("_id",doc.getObjectId("_id"));
...
//            Document());
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://m220student:m220password@mflix.1ud4u.mongodb.net";
        ...
        String date = "2015-09-12 09:51:28.903000000";
        String datePattern = "yyyy-MM-dd HH:mm:ss";
        Bson dateStringFilter =  Filters.and(Filters.exists("lastupdated",true), Filters.type("lastupdated", BsonType.STRING));
